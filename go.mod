...
require (
	...
	github.com/ConsenSys/fc-retrieval-provider-admin v0.0.0-20210226022834-ba5b83d7b8d2
	github.com/ConsenSys/fc-retrieval-register v0.0.0-20210226020259-8e5d7fa2d193 // indirect
